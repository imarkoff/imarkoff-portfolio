...
import ButtonContent, {ButtonContentProps} from '../../Button/components/ButtonContent';
import getButtonClasses, {ButtonClassesProps} from '../../Button/utils/getButtonClasses';
...
vi.mock("../../Button/components/ButtonContent", () => ({
    default: vi.fn(({children}) => (<span>{children}</span>))
}));

vi.mock("../../Button/utils/getButtonClasses", () => ({
