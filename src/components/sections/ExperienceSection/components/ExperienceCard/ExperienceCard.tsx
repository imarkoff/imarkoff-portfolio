...
export default function ExperienceCard(
    ...
    return (
        <ExperienceCardWrapper references={REFERENCES} isPresent={isPresent}>
            <div className={`flex-1 hidden lg:block ${REFERENCES.leftSideClassName}`}>
                <ExperienceTitle experience={experience} />
            </div>
            <ExperienceLine references={REFERENCES.line} index={index} />
            <div className={`flex-1 pb-6 lg:py-12 flex flex-col gap-2.5 ${REFERENCES.rightSideClassName}`}>
