...
import useShowcaseAppear from "@/app/components/sections/HeroSection/components/SomeShowcasesArrow/hooks/useShowcaseAppear";
import ArrowSVG from "@/app/components/sections/HeroSection/components/SomeShowcasesArrow/components/ArrowSVG";
import Typography from "@/app/components/ui/Typography";

vi.mock("@/app/components/sections/HeroSection/components/SomeShowcasesArrow/hooks/useShowcaseAppear", () => ({
    default: vi.fn(() => ({
...
vi.mock("@/app/components/sections/HeroSection/components/SomeShowcasesArrow/components/ArrowSVG", () => ({
