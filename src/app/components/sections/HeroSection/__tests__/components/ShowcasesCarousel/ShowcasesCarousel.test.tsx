...
import useCarouselAppear
    from "@/app/components/sections/HeroSection/components/ShowcaseCarousel/hooks/useCarouselAppear";

vi.mock('@/app/components/ui/VerticalTicker/VerticalTicker', () => ({
...
vi.mock('@/app/components/sections/HeroSection/components/ShowcaseCarousel/hooks/useCarouselAppear', () => ({
