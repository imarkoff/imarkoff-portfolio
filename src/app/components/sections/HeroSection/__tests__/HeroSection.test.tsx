...
import ShowcaseCarousel from "@/app/components/sections/HeroSection/components/ShowcaseCarousel/ShowcaseCarousel";

vi.mock('@/app/components/ui/Section', () => ({
    default: vi.fn(({ children }) => <section>{children}</section>),
}));
vi.mock('@/app/components/sections/HeroSection/components/DownArrow', () => ({
    default: vi.fn(() => <div data-testid="down-arrow" />),
}));
vi.mock('@/app/components/sections/HeroSection/components/ShowcaseCarousel/ShowcaseCarousel', () => ({
    default: vi.fn(() => <div data-testid="showcase-carousel" />),
}));
vi.mock('@/app/components/ui/GradientBlur', () => ({
    default: vi.fn(() => <div data-testid="gradient-blur" />),
}));
vi.mock('@/app/components/sections/HeroSection/components/SomeShowcasesArrow/SomeShowcasesArrow', () => ({
    default: vi.fn(() => <div data-testid="some-showcases-arrow" />),
}));
vi.mock('@/app/components/sections/HeroSection/components/HeroBackground', () => ({
