...
export default function HeroSection({aboutMe}: { aboutMe: AboutMe }) {
    ...
    return (
        <Section slotProps={{
                ...
                <div className={"flex flex-col items-start gap-6"}>
                    ...
                    <div className={"flex flex-col"}>
                        <Typography variant={"tagline"} component={"h3"}>
                            <span className={"inline-block"} id={greetingHiId}>Hi 👋</span> <span className={"inline-block"} id={greetingOtherId}>, I’m</span>
                        </Typography>
            ...
            <SomeShowcasesArrow />
            <div className={"absolute -top-full bottom-0 right-0 translate-x-2/3 translate-y-1/3 flex items-center justify-center"}>
                <ShowcaseCarousel />
            </div>
